...
cells(end+1)=cellclass(2,50,45);
cells(end+1)=cellclass(2,45,50);
cells(end+1)=cellclass(2,55,50);
cells(end+1)=cellclass(2,50,55);
cells(end+1)=cellclass(1,60,40);
cells(end+1)=cellclass(1,60,50);
cells(end+1)=cellclass(1,60,60);
cells(end+1)=cellclass(1,50,40);
cells(end+1)=cellclass(1,50,60);
cells(end+1)=cellclass(1,40,40);
cells(end+1)=cellclass(1,40,50);
cells(end+1)=cellclass(1,40,60);
