...
cells(end+1)=cellclass(1,45,50);
cells(end+1)=cellclass(2,47,50);
cells(end+1)=cellclass(1,49,50);
cells(end+1)=cellclass(2,51,50);
cells(end+1)=cellclass(1,53,50);
cells(end+1)=cellclass(2,55,50);
cells(end+1)=cellclass(1,57,50);
